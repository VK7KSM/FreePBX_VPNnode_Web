...
final class SystemLock {
    ...
    void disabled(boolean value)throws Exception{credentialCommand("set-disabled",knownPassword,Boolean.toString(value));if(disabled()!=value)throw new IllegalStateException("lost-lock-state-failed");}
