...
test("管理路由匿名与伪造标记均不能绕过登录，未知 API 默认保护", async () => {
  const f = fixture();
  const routes = ["/api/data", "/api/save", "/api/sip", "/api/sip/live", "/api/sip/save", "/api/devices", "/api/device-models", "/api/devices/update", "/api/devices/delete", "/api/devices/pair", "/api/elfremote/task", "/api/elfremote/releases", "/api/elfremote/assign", "/api/elfremote/adb/session", "/api/elfremote/adb/browser", "/api/elfremote/adb-tunnel/session", "/api/new-admin-route"];
