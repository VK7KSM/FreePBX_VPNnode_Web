...
function renderDevicesHtml() {
  return [
    ...
    '.remote-title{display:flex;align-items:center;gap:8px;min-width:0;flex-wrap:wrap}.remote-title h3{flex-shrink:0}#serviceError{font-size:11px;font-weight:400;color:#f87171;line-height:1.4}',
