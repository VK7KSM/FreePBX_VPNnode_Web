...
function renderDevicesHtml() {
  return [
    ...
    '.share-mode .btn-add,.share-mode .action-disable,.share-mode .action-enable,.share-mode .action-unpair,.share-mode .action-pair,.share-mode .fn-btn[data-fn=model],.share-mode .admin-only{display:none!important}.share-mode #shareDeviceName{font-weight:700;font-size:1.05rem;white-space:nowrap}.share-mode .share-brand-sub{color:#93c5fd;font-size:.85rem;font-weight:600;white-space:nowrap;margin-left:.4rem}.share-dialog{width:760px;max-height:calc(100vh - 40px);overflow:auto;font-size:14px;color:#e2e8f0}.share-dialog h3{font-size:16px}.share-pick{word-break:break-all;font-size:14px;color:#e2e8f0}.share-current{font-size:13px;color:#cbd5e1}.share-form-row{display:flex;align-items:center;gap:12px;flex-wrap:wrap}.share-form-row label{display:flex;align-items:center;gap:6px;font-size:14px;color:#e2e8f0}.share-form-row input.inp{width:170px;height:34px;font-size:14px}.share-form-row select.inp{width:150px;height:34px;font-size:14px;line-height:34px;padding:0 8px}.share-form-row button{height:34px;font-size:14px;padding:0 14px}.share-edit legend{font-size:13px}.action-share{background:#3b6fa8}.share-table{width:100%;border-collapse:collapse;margin-top:12px;font-size:14px;color:#e2e8f0}.share-table th{color:#94a3b8;font-weight:400;white-space:nowrap}.share-table th,.share-table td{padding:8px 8px;text-align:left;border-bottom:1px solid #29364a;vertical-align:middle;overflow-wrap:anywhere}.share-table tr.on td{background:#1e293b}.share-table tr.current td:first-child{color:#93c5fd}.share-pick{background:none;border:0;padding:0;color:#cbd5e1;font:inherit;cursor:pointer;text-align:left}.share-pick:hover{text-decoration:underline}.share-row-actions{white-space:nowrap}.share-row-actions button{margin-left:4px;padding:4px 10px;min-height:30px;font-size:13px}.share-qr{display:flex;align-items:center;gap:14px;margin-top:12px}.share-qr svg{width:200px;height:200px;background:#fff;border-radius:6px}.share-qr div{font-size:14px;color:#e2e8f0}.share-edit{border:1px solid #29364a;border-radius:8px;padding:10px 12px;margin-top:12px;display:grid;gap:10px}.share-edit legend{color:#94a3b8;padding:0 6px}.share-edit label{display:flex;align-items:center;gap:8px}.share-edit input.inp,.share-edit select.inp{flex:1;min-width:0;height:32px}.share-inline{color:#f87171}.share-error{margin:8px 0 0;color:#fbbf24}.share-current{margin-top:6px}.share-locked-notice{margin:8px 0;padding:6px 10px;border-radius:6px;background:#3b2f0b;color:#fbbf24;font-size:12px}',
