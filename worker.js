...
function renderDevicesHtml() {
  return [
    ...
    '.kv{background:rgba(15,23,42,.55);border:1px solid #1e293b;border-radius:.55rem;padding:.55rem .7rem}',
    '.kv .k{font-size:.75rem;color:#94a3b8}',
    '.kv .v{margin-top:.28rem;font-size:.9rem;word-break:break-all;line-height:1.3}',
    ...
    '.fn-menu{display:flex;flex-wrap:wrap;gap:.55rem;margin:.75rem 0 .65rem}',
    '.fn-btn{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:.4rem;min-width:104px;padding:.7rem .55rem;background:#1e293b;border:1px solid #334155;border-radius:.7rem;color:#e2e8f0;cursor:pointer;font-size:.8rem;font-weight:600}',
    '.fn-btn:hover{border-color:#60a5fa;background:#1e3a5f}',
    '.fn-btn.on{border-color:#3b82f6;background:#1e3a5f;color:#93c5fd}',
    '.fn-ico{width:30px;height:30px;display:block}',
