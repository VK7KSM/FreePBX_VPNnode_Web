...
function renderSipHtml() {
  return [
    ...
    '<\/div><\/div>',
    '<div style="overflow-x:auto"><table class="sip-table"><colgroup><col class="c-chk"><col class="c-on"><col class="c-ext"><col><col><col><col><col style="width:56px"><col style="width:80px"><\/colgroup><thead><tr>',
    '<th><\/th><th>在线<\/th><th>分机号<\/th><th>名称<\/th><th>公网号码<\/th><th>呼入/短信转发<\/th><th>外呼路由<\/th><th>传输<\/th><th>延时<\/th>',
...
function renderDevicesHtml() {
  return [
    ...
    '.layout{display:grid;grid-template-columns:220px 1fr;grid-template-rows:minmax(360px,52vh) auto;gap:1rem}',
    ...
    '#devOps{grid-column:1/-1;padding:.75rem 1rem .85rem}',
    '.ops-head{display:flex;align-items:center;gap:.6rem;margin-bottom:.5rem;flex-wrap:wrap}',
    ...
    '.ops-head-actions .inp{width:150px;padding:.32rem .6rem;font-size:.8rem}',
    '.ops-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:.35rem}',
    '@media(max-width:800px){.ops-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}',
    '.kv{display:flex;align-items:center;justify-content:space-between;gap:.45rem;background:rgba(15,23,42,.55);border:1px solid #1e293b;border-radius:.4rem;padding:.22rem .55rem;min-height:0}',
    '.kv .k{font-size:.7rem;color:#94a3b8;flex-shrink:0}',
    '.kv .v{margin:0;font-size:.8rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
    '.ops-sec{margin-top:.5rem;padding-top:.45rem;border-top:1px solid #1e293b}',
    '.ops-sec-title{font-size:.75rem;color:#94a3b8;margin:0 0 .35rem}',
    '.ops-actions{display:flex;flex-wrap:wrap;gap:.4rem;align-items:center}',
    '.ops-head-actions .btn-gray:disabled,.ops-head-actions .btn-green:disabled,.ops-actions .btn-gray:disabled,.ops-actions .btn-green:disabled{opacity:.45;cursor:default}',
    'table{width:100%;border-collapse:collapse}',
