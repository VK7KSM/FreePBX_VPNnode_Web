...
function renderDevicesHtml() {
  return [
    ...
    '.remote-preview img,.remote-preview video{width:100%;height:100%;object-fit:contain}.traffic-link{border:0;background:none;color:#93c5fd;padding:0;cursor:pointer;font-size:11px;white-space:nowrap}.system-tabs{display:flex;gap:8px;flex-wrap:wrap;margin:12px 0}.system-tabs .active{background:#2563eb}.system-items>div{display:flex;justify-content:space-between;padding:12px;border-bottom:1px solid #334155}.report-feedback{font-size:12px;color:#b1bdcb}.ops-head-left{flex-wrap:wrap}.traffic-header{display:flex;align-items:center;justify-content:space-between;gap:12px;padding-right:28px;margin-bottom:22px}.traffic-header h3{margin:0;font-size:15px;white-space:nowrap}.traffic-range{display:flex;align-items:center;gap:4px;color:#64748b}.traffic-range input{font:inherit;font-size:11px;width:108px;height:28px;padding:3px 5px;color:#cbd5e1;background:#111c2c;border:1px solid #334155;border-radius:5px;color-scheme:dark}#trafficChart{overflow-x:auto;padding:0 8px}.traffic-plot{width:100%}.traffic-bars{display:flex;align-items:end;height:210px;border-bottom:1px solid #445066;background:repeating-linear-gradient(to top,transparent 0,transparent 69px,#33415555 69px,#33415555 70px)}.traffic-bar{border:0;background:none;flex:1;min-width:0;height:100%;padding:0;cursor:pointer;display:flex;justify-content:center;align-items:end;position:relative}.traffic-stack{display:flex;flex-direction:column;justify-content:flex-end;width:6px;border-radius:3px 3px 0 0;overflow:hidden}.traffic-stack i{display:block;flex-shrink:0}.traffic-rx{background:#60a5fa}.traffic-tx{background:#f5c451}.traffic-bar:hover .traffic-stack,.traffic-bar.selected .traffic-stack{outline:1px solid #f8fafc;outline-offset:2px}.traffic-bar.selected:before{content:"";position:absolute;top:8px;bottom:0;width:1px;background:#cbd5e144}.traffic-axis{height:30px;position:relative;font-size:11px;color:#94a3b8;margin-top:9px}.traffic-axis span{position:absolute;transform:translateX(-50%);white-space:nowrap}.traffic-axis span:first-child{transform:none;left:0!important}.traffic-axis span:last-child{transform:translateX(-100%);left:100%!important}#trafficDetail{margin:4px -20px -20px;padding:14px 20px;background:#111c2c;border-radius:0 0 14px 14px;color:#d4deec;font-size:12px;line-height:1.8;font-variant-numeric:tabular-nums}#trafficHistoryWrap .modal-card{width:min(820px,95vw);padding:20px;border-radius:14px}@media(max-width:500px){.traffic-header{gap:6px;padding-right:22px}.traffic-header h3{font-size:13px}.traffic-range{gap:2px}.traffic-range input{width:94px;font-size:10px;padding:2px}#trafficHistoryWrap .modal-card{padding:16px}.traffic-header{margin-bottom:16px}#trafficDetail{margin:4px -16px -16px;padding:12px 16px}.remote-traffic{gap:6px!important}}',
    ...
    '<\/div>',
    '<\/div><\/main>',
    '<div id="trafficHistoryWrap" class="modal-bg" style="display:none"><div class="card modal-card"><button class="btn-close" onclick="closeTrafficHistory()" aria-label="关闭流量历史">&times;</button><div id="trafficHistoryBody"></div></div></div>',
