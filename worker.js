...
function renderDevicesHtml() {
  return [
    ...
    '.desktop-view{display:flex;flex-direction:column;height:340px;min-height:340px;max-height:340px;background:#000;border-top:1px solid #29364a}.desktop-stage{position:relative;flex:1;min-height:0}.desktop-screen{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;outline:none;touch-action:none;user-select:none;cursor:crosshair}.desktop-canvas{max-width:100%;max-height:100%;width:auto;height:auto;display:block}.desktop-tools{position:absolute;left:0;top:0;bottom:0;width:52px;display:flex;flex-direction:column;justify-content:center;gap:6px;padding:8px 6px;box-sizing:border-box;background:rgba(15,23,42,.85);border-right:1px solid #29364a;overflow:auto}.desktop-tools button{width:40px;height:40px;min-height:40px;padding:0;display:inline-flex;align-items:center;justify-content:center;background:#1e293b;color:#e2e8f0;border:0;border-radius:8px;cursor:pointer;flex-shrink:0}.desktop-tools button svg{width:22px;height:22px}.desktop-tools button:hover,.desktop-tools button:focus-visible{background:#3b82f6;color:#fff}.desktop-unfold{position:absolute;left:0;top:0;bottom:0;width:10px;padding:0;border:0;background:rgba(51,65,85,.8);cursor:pointer}.desktop-info{position:absolute;top:8px;right:8px;display:flex;flex-direction:column;gap:2px;padding:6px 10px;border-radius:6px;background:rgba(15,23,42,.85);color:#cbd5e1;font-size:12px;line-height:1.5;max-width:60%;pointer-events:none}.desktop-info[hidden]{display:none}.desktop-info span{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.desktop-foot{display:none}',
    '.share-mode .btn-add,.share-mode .ops-head-actions .action-disable,.share-mode .ops-head-actions .action-enable,.share-mode .ops-head-actions .action-unpair,.share-mode .ops-head-actions .action-pair,.share-mode .fn-btn[data-fn=model],.share-mode .admin-only{display:none!important}.share-mode #shareDeviceName{font-weight:700;font-size:1.05rem;white-space:nowrap}.share-mode .share-brand-sub{color:#93c5fd;font-size:.85rem;font-weight:600;white-space:nowrap;margin-left:.4rem}.share-dialog{width:960px;max-width:calc(100vw - 32px);max-height:calc(100vh - 40px);overflow:auto;font-size:14px;color:#e2e8f0}.share-dialog h3{font-size:16px}.share-dialog .btn-close.share-close{background:#7f1d1d;border:1px solid #b91c1c;color:#fecaca;width:28px;height:28px;border-radius:6px;font-size:18px;line-height:1}.share-form-row{display:flex;align-items:center;gap:14px;flex-wrap:wrap}.share-form-row label{display:flex;align-items:center;gap:8px;font-size:14px;color:#e2e8f0;white-space:nowrap}.share-form-row input.inp{width:180px;height:34px;font-size:14px;padding:0 10px}.share-form-row select.inp{width:120px;height:34px;font-size:14px;line-height:34px;padding:0 8px}.share-form-row button{height:34px;font-size:14px;padding:0 16px}.share-edit{border:1px solid #29364a;border-radius:8px;padding:12px 14px;margin-top:14px}.share-edit legend{font-size:13px;color:#94a3b8;padding:0 6px}.share-table{width:100%;border-collapse:collapse;margin-top:16px;font-size:14px;color:#e2e8f0;table-layout:auto}.share-table th{color:#94a3b8;font-weight:400;white-space:nowrap}.share-table th,.share-table td{padding:10px 10px;text-align:left;border-bottom:1px solid #29364a;vertical-align:middle;white-space:nowrap}.share-table tr.on td{background:#1e293b}.share-table td.share-link-cell{position:relative;white-space:normal;word-break:break-all;min-width:240px}.share-link{font-family:ui-monospace,Consolas,monospace;font-size:14px;color:#93c5fd;cursor:pointer}.share-link:hover{text-decoration:underline}.share-tag{margin-left:8px}.share-qr-pop{display:none;position:absolute;left:0;top:100%;z-index:20;padding:8px;background:#fff;border-radius:8px;box-shadow:0 8px 24px rgba(0,0,0,.5)}.share-qr-pop svg{width:180px;height:180px;display:block}.share-link-cell:hover .share-qr-pop,.share-link:focus-visible+.share-qr-pop{display:block}.share-row-actions{text-align:right}.share-row-actions button{padding:5px 14px;min-height:30px;font-size:13px}.share-empty{color:#94a3b8}.share-error{margin:8px 0 0;color:#fbbf24}.share-lock-tag{margin-left:10px;padding:2px 8px;border-radius:5px;background:#3b2f0b;color:#fbbf24;font-size:12px;white-space:nowrap}.action-share{background:#3b6fa8}',
