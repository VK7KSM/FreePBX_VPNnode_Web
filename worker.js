...
function renderDevicesHtml() {
  return [
    ...
    '.ops-head{display:flex;align-items:baseline;gap:.8rem;margin-bottom:.8rem;flex-wrap:wrap}',
    '.ops-head h3{margin:0;font-size:1.1rem}',
    '.ops-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:.7rem;margin-bottom:.2rem}',
    ...
    '.ops-sec{margin-top:.85rem;padding-top:.75rem;border-top:1px solid #1e293b}',
    '.ops-sec-title{font-size:.75rem;color:#94a3b8;margin:0 0 .45rem}',
    '.ops-actions{display:flex;flex-wrap:wrap;gap:.5rem;align-items:center}',
    '.ops-actions .btn-gray:disabled,.ops-actions .btn-green:disabled{opacity:.45;cursor:default}',
    'table{width:100%;border-collapse:collapse}',
