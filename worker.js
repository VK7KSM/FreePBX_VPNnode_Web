...
function renderDevicesHtml() {
  return [
    ...
    '.share-mode .btn-add,.share-mode .ops-head-actions .action-disable,.share-mode .ops-head-actions .action-enable,.share-mode .ops-head-actions .action-unpair,.share-mode .ops-head-actions .action-pair,.share-mode .fn-btn[data-fn=model],.share-mode .admin-only{display:none!important}.share-mode #shareDeviceName{font-weight:700;font-size:1.05rem;white-space:nowrap}.share-mode .share-brand-sub{color:#93c5fd;font-size:.85rem;font-weight:600;white-space:nowrap;margin-left:.4rem}.file-send-wrap .file-send-dialog.share-dialog{width:760px;max-width:calc(100vw - 32px);max-height:none;overflow:visible;padding:22px 24px;font-size:14px;color:#e2e8f0;background:linear-gradient(180deg,#0f1a2e 0%,#0b1424 100%);border:1px solid #2b3a52;box-shadow:0 20px 60px rgba(0,0,0,.55)}.share-dialog h3{font-size:17px;font-weight:600;letter-spacing:.2px}.share-dialog .btn-close.share-close{background:#b91c1c;border:0;color:#fff;width:30px;height:30px;border-radius:8px;font-size:18px;line-height:1}.share-panel{margin-top:16px;padding:16px 18px;border-radius:12px;background:#111c30;border:1px solid #223047}.share-panel-title{font-size:13px;color:#8fa3bf;margin-bottom:12px;letter-spacing:.3px}.share-panel-title code{color:#93c5fd;font-family:ui-monospace,Consolas,monospace}.share-form-row{display:flex;align-items:center;gap:12px;flex-wrap:nowrap}.share-form-row label{display:flex;align-items:center;gap:10px;font-size:14px;color:#e2e8f0;white-space:nowrap}.share-form-row label.share-ttl{margin-left:16px}.share-form-row input.inp,.share-form-row select.inp{box-sizing:border-box;width:190px;height:38px;font-size:14px;line-height:36px;padding:0 12px;margin:0;border-radius:9px;background:#0b1220;border:1px solid #2b3a52;color:#e2e8f0}.share-form-row input.inp:focus,.share-form-row select.inp:focus{outline:none;border-color:#3b82f6;box-shadow:0 0 0 3px rgba(59,130,246,.25)}.share-form-actions{margin-left:auto;display:flex;gap:8px}.share-btn{height:38px;padding:0 18px;border:0;border-radius:9px;font-size:14px;font-weight:500;color:#fff;cursor:pointer;white-space:nowrap;transition:filter .15s,transform .05s}.share-btn:hover{filter:brightness(1.12)}.share-btn:active{transform:translateY(1px)}.share-btn-primary{background:linear-gradient(180deg,#22c55e,#15803d)}.share-btn-ghost{background:#334155}.share-btn-danger{background:linear-gradient(180deg,#ef4444,#b91c1c);height:34px;padding:0 16px;flex-shrink:0}.share-list-title{margin:20px 0 10px;font-size:13px;color:#8fa3bf;letter-spacing:.3px;display:flex;align-items:center;gap:8px}.share-count{display:inline-flex;align-items:center;justify-content:center;min-width:20px;height:20px;padding:0 6px;border-radius:10px;background:#1e293b;color:#cbd5e1;font-size:12px}.share-list{display:flex;flex-direction:column;gap:10px;max-height:44vh;overflow:auto;padding-right:2px}.share-item{position:relative;display:flex;align-items:center;gap:14px;padding:12px 14px 12px 18px;border:1px solid #223047;border-radius:12px;background:#0f1a2e;transition:border-color .15s,background .15s}.share-item::before{content:"";position:absolute;left:0;top:10px;bottom:10px;width:4px;border-radius:0 4px 4px 0;background:#334155}.share-item:hover{border-color:#3b82f6;background:#132038}.share-item.on{border-color:#3b82f6;background:#152444}.share-item.on::before{background:#3b82f6}.share-item.live{border-color:#22c55e;animation:shareLive 1.6s ease-in-out infinite}.share-item.live::before{background:#22c55e}@keyframes shareLive{0%,100%{box-shadow:0 0 0 0 rgba(34,197,94,.0)}50%{box-shadow:0 0 0 4px rgba(34,197,94,.28)}}.share-item-main{flex:1;min-width:0;display:flex;flex-direction:column;gap:5px}.share-item-link{display:flex;align-items:center;gap:10px;min-width:0}.share-link{font-family:ui-monospace,Consolas,monospace;font-size:14px;color:#93c5fd;cursor:pointer;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.share-link:hover{text-decoration:underline}.share-copy{flex-shrink:0;background:none;border:0;padding:0 4px;color:#60a5fa;font-size:13px;cursor:pointer}.share-copy:hover{text-decoration:underline}.share-item-meta{font-size:13px;color:#94a3b8;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.share-live-badge{flex-shrink:0;padding:4px 10px;border-radius:8px;background:rgba(34,197,94,.15);border:1px solid rgba(34,197,94,.5);color:#86efac;font-size:12px;white-space:nowrap}.share-qr-pop{position:fixed;z-index:3000;padding:8px;background:#fff;border-radius:10px;box-shadow:0 10px 30px rgba(0,0,0,.55);pointer-events:none}.share-qr-pop svg{width:180px;height:180px;display:block}.share-qr-pop[hidden]{display:none}.share-empty{color:#8fa3bf;padding:14px;border:1px dashed #2b3a52;border-radius:12px;text-align:center}.share-error{margin:8px 0 0;color:#fbbf24}.share-lock-tag{margin-left:10px;padding:2px 8px;border-radius:5px;background:#3b2f0b;color:#fbbf24;font-size:12px;white-space:nowrap}.action-share{background:#3b6fa8}',
