...
const DEVICE_ID_BODY=new Set(['/api/devices/request-status','/api/elfremote/task','/api/elfremote/mcp-tokens','/api/elfremote/mcp-tokens/delete','/api/elfremote/assign','/api/elfremote/media/session','/api/elfremote/adb/session','/api/elfremote/adb-tunnel/session','/api/elfremote/desktop/session','/api/elfremote/files','/api/elfremote/file-return','/api/share/links','/api/share/links/update','/api/share/links/delete']);
