...
public class MainViewModel extends AndroidViewModel {
    ...
    private void loadConfig() {
        ...
        audio.captureRoute = config.getCaptureRoute();
        audio.injectionRoute = config.getInjectionRoute();
    ...
    public void saveAudioConfig(int card, int capture, int playback,
                                String captureRoute, String injectionRoute,
                                float txGain, float rxGain, Set<String> muteControls,
                                String manualControls) {
        GatewayConfig config = GatewayConfig.getInstance();
        config.updateAudioConfig(card, capture, playback, captureRoute, injectionRoute);
        ...
        Log.d(TAG, "Audio config saved: card=" + card + ", capture=" + capture +
              ", playback=" + playback + ", captureRoute=" + captureRoute +
     ...
     */
    public void saveFullAudioConfig(int card, int capture, int playback,
                                    String captureRoute, String injectionRoute) {
        GatewayConfig config = GatewayConfig.getInstance();
        config.updateAudioConfig(card, capture, playback, captureRoute, injectionRoute);
        loadConfig();
     ...
     *
     * @param preset The preset name (e.g., "pixel_3_xl", "custom")
     */
    ...
    public static class AudioConfig {
        public int card = 0;
        public int captureDevice = GatewayConfig.PIXEL_CAPTURE_DEVICE;
        public int playbackDevice = GatewayConfig.PIXEL_PLAYBACK_DEVICE;
        public String captureRoute = GatewayConfig.PIXEL_CAPTURE_ROUTE;
        public String injectionRoute = GatewayConfig.PIXEL_INJECTION_ROUTE;
