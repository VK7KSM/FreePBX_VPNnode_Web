...
public class DeviceMuteManager {
    ...
    public static final String PRESET_PIXEL_3_XL = "pixel_3_xl";          // SDM845, discovery only
    ...
    static {
        // Pixel 3 XL profile intentionally performs no mixer writes until its
        // Android 12 audio routes have been measured during controlled calls.
        PRESETS.put(PRESET_PIXEL_3_XL, new DevicePreset(
            "Pixel 3 XL (SDM845, safe diagnostics)",
            new String[0],
            new String[0],
            new String[0]
        ));
    ...
    private void loadPreset() {
        ...
        currentPreset = prefs.getString(PREF_PRESET, PRESET_PIXEL_3_XL);
